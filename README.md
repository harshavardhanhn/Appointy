...
**Appointy** is a full-stack web application designed to make healthcare more accessible by simplifying the process of booking doctor appointments. It offers three levels of login: **Patient**, **Doctor**, and **Admin**, each with distinct features tailored to their roles. Built using the **MERN stack** (MongoDB, Express.js, React.js, and Node.js), Appointy provides an efficient, user-friendly experience for both patients and healthcare providers.
...
- **Database**: MongoDB
- **Payment**: Local stub (for development)
...
- **Patient Login**: 
  ...
  - Secure online payment option available: cash. Payments are simulated locally for development.
...
- Displays detailed information about the selected doctor:
  ...
  - Online payment options: **Cash**. Payments are simulated locally for development.
...
- Supports **Cash Payment**. External payment gateways have been removed; payments are simulated locally for development and testing.
...
3. **Environment Variables**:
   - Create a `.env` file in the `backend` folder and add at minimum:
     ```env
